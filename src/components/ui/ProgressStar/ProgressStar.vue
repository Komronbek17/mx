...
const checkOpacity = () => {
  return checkIsActive() ? '.5' : 'var(--star-opacity)'
}
</script>
    ...
    <div class="progress-star__icon">
      ...
      >
        ...
        <g mask="url(#mask0_127_10)">
          <rect
              v-if="checkIconIndex(0)"
              :width="getWidth()"
              height="36"
              fill="url(#paint0_linear_127_10)"
          />
          <rect
              v-else-if="checkIconIndex(1)"
              :width="getWidth()"
              height="36"
              fill="url(#paint0_linear_127_11)"
          />
          <rect
              v-else-if="checkIconIndex(2)"
              :width="getWidth()"
              height="36"
              fill="url(#paint0_linear_127_12)"
          />
          <rect
              v-else-if="checkIsActive"
              :width="getWidth()"
              height="36"
