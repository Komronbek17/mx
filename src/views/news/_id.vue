        ...
        <div class="swiper-content">
          ...
          <div class="layout-container">
            <div style="color: red">
              ...
              <p class="one-news__title">
                Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                Debitis hic iusto neque officiis! Alias aperiam aut debitis
                dolore dolorem doloremque ea eos esse, exercitationem harum,
                inventore ipsam ipsum maxime minima nostrum omnis rem
                repellendus reprehenderit sequi, sint. Accusantium alias cum
                cupiditate, et fuga impedit ipsum itaque molestiae officia
                reprehenderit soluta tenetur ullam, voluptas. Aliquam
                consectetur earum impedit laborum maxime neque temporibus
                veniam, voluptatem. Animi autem beatae consequuntur cum
                distinctio dolore doloremque dolores earum eum eveniet excepturi
                harum impedit in incidunt molestiae nemo, nisi nobis officiis,
                pariatur porro quaerat repudiandae sed sunt, tenetur vero.
                Accusamus aliquid asperiores at, aut beatae blanditiis cum
                deleniti dicta dolorem doloribus earum eligendi eos ex fuga
                incidunt ipsa ipsum iste iure laborum nemo neque nihil nulla
                obcaecati officia porro quae quaerat qui quibusdam repellendus
                reprehenderit, repudiandae soluta suscipit tempore tenetur ut
                vel veritatis. A amet cumque dolorum est ex iure nemo sunt
                temporibus? Ad deleniti deserunt dolor dolore esse hic itaque,
                libero maiores maxime, perferendis quis quod, ullam voluptatum.
                Ab accusantium alias aperiam, autem beatae blanditiis dicta
                dolorum fuga illo ipsum modi mollitia natus nobis odio, optio
                possimus reiciendis reprehenderit vel! A accusantium excepturi
                itaque minus neque nesciunt pariatur quia, quo sunt vitae.
                Cupiditate dolores magnam ratione repellendus reprehenderit! Ab
                ad architecto, blanditiis culpa deleniti distinctio dolorem
                eligendi exercitationem harum inventore laudantium, nihil
                nostrum, officia omnis provident sequi soluta temporibus
                voluptates! Beatae deleniti fuga fugiat fugit, in incidunt iusto
                minus perferendis placeat praesentium, quam voluptatum. Alias
                aliquam aut autem commodi consectetur culpa deleniti dolorem
                doloremque exercitationem facilis fuga incidunt ipsam itaque
                magni maxime natus nisi non odio possimus, voluptatem. Animi,
                dicta dolore ipsum iste recusandae velit veritatis! Aliquid
                deleniti distinctio dolor dolore hic itaque obcaecati odit porro
                provident temporibus, vero voluptate? Corporis cumque debitis
                dignissimos eligendi exercitationem inventore, maxime natus
                neque numquam odio optio porro sequi.
              </p>

              <div
                class="one-news__description"
                v-html="newData.description"
              ></div>

              <div
                v-if="newData.likes"
                class="one-news__btns flex align-center"
              >
